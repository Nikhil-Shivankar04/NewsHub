...
<body>
  ...
  $query=mysqli_query($conn,"select * from sports_news where nid='1'");
...
<div class="cards-container" id="cards-container">
  <div class="card">
    <div class="card-container" >
      <a href="s1.php"><?php $img1=$op['news_img']; ?><img src="<?php echo $img1; ?>" alt="news" id="news-img"></a>
  </div>
...
<?php
  $conn=mysqli_connect("localhost","root","","newssite");
  $query=mysqli_query($conn,"select * from sports_news where nid='2'");
  $op=mysqli_fetch_array($query);
  ?>
 <div class="card">

    <div class="card-container">
      <a href="s2.php"><?php $img2=$op['news_img']; ?><img src="<?php echo $img2; ?>" alt="news"></a>
  </div>
      <div class="card-content">
...
<!------------------------------------------------------------------------------------------------------>
<?php
$query=mysqli_query($conn,"select * from sports_news where nid='3'");
$op=mysqli_fetch_array($query);
?>
 <div class="card">
    <div class="card-container">
      <a href="s3.php"><?php $img=$op['news_img']; ?><img src="<?php echo $img; ?>" alt="news"></a>
  </div>
      <div class="card-content">
        <h6 id="source">TIMESOFINDIA.COM | <?php echo $op['date_and _time']; ?></h6>
...
<!------------------------------------------------------------------------------------------------------>
<?php
$query=mysqli_query($conn,"select * from sports_news where nid='4'");
$op=mysqli_fetch_array($query);
?>
 <div class="card">
    <div class="card-container">
      <a href="s4.php"><?php $img=$op['news_img']; ?><img src="<?php echo $img; ?>" alt="news"></a>
...
<main>
  <!------------------------------------------------------------------------------------------------>
<?php
$query=mysqli_query($conn,"select * from sports_news where nid='5'");
$op=mysqli_fetch_array($query);
?>
<div class="cards-container" id="cards-container">
  <div class="card">
    <div class="card-container" >
      <a href="s5.php"><?php $img=$op['news_img']; ?><img src="<?php echo $img; ?>" alt="news" id="news-img"></a>
  </div>
      <div class="card-content">
...
<!------------------------------------------------------------------------------------------------>
<?php
$query=mysqli_query($conn,"select * from sports_news where nid='6'");
$op=mysqli_fetch_array($query);
?>
 <div class="card">
    <div class="card-container">
      <a href="s6.php"><?php $img=$op['news_img']; ?><img src="<?php echo $img; ?>" alt="news"></a>
  </div>
      <div class="card-content">
...
<!------------------------------------------------------------------------------------------------>
<?php
$query=mysqli_query($conn,"select * from sports_news where nid='7'");
$op=mysqli_fetch_array($query);
?>
 <div class="card">
    <div class="card-container">
      <a href="s7.php"><?php $img=$op['news_img']; ?><img src="<?php echo $img; ?>" alt="news"></a>
  </div>
      <div class="card-content">
...
<!------------------------------------------------------------------------------------------------>
<?php
$query=mysqli_query($conn,"select * from sports_news where nid='8'");
$op=mysqli_fetch_array($query);
?>
 <div class="card">
    <div class="card-container">
      <a href="s8.php"><?php $img=$op['news_img']; ?><img src="<?php echo $img; ?>" alt="news"></a>
  </div>
      <div class="card-content">
